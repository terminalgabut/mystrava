...
<div class="bento-card p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
    ...
    <p class="text-xs text-slate-500 mt-1">Kapasitas kardiovaskular kumulatif keseluruhan berdasarkan tren jangka panjang (EMA).</p>
        ...
        <!-- CARD 4: PROPULSION ENGINE + FATIGUE LEVEL -->
        <div class="bento-card p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
            <div class="card-header flex justify-between items-center mb-2">
            ...
            <p class="text-[10px] font-bold text-slate-500 mt-1 flex items-center gap-1">
                <span class="w-1.5 h-1.5 rounded-full" :class="sciStats.latestFatigue > 50 ? 'bg-red-500 animate-pulse' : 'bg-blue-500'"></span>
                Sesi Fatigue: {{ sciStats.latestFatigue }}%
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="flex flex-col gap-6">
            <!-- REFACTOR: Memasang Komponen Combo Chart Baru -->
            <div class="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
